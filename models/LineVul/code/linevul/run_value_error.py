...
cache_name = f"cache/multi_value_error_train_last_second_layer.npy"
...
cache_name = r"cache/multi_value_error_test_last_second_layer.npy"
np_file = np.load(cache_name, allow_pickle=True)
...
for ood_dataset in out_datasets:
    ...
    cache_name = f"cache/multi_value_error_ood_last_second_layer.npy"
    # cache_name = f"cache/multi_value_error_devign_train_last_second_layer.npy.npz"
    # cache_name = f"cache/multi_value_error_text_train_last_second_layer.npy.npz"
    # cache_name = f"cache/multi_value_error_text_test_last_second_layer.npy.npz"
    cache_name = f"cache/multi_value_error_text_ood_last_second_layer.npy"
    # cache_name = f"cache/multi_value_error_ruby_last_second_layer.npy.npz"
    # cache_name = f"cache/multi_value_error_php_last_second_layer.npy.npz"
    # cache_name = f"cache/multi_value_error_javascript_last_second_layer.npy.npz"
    # cache_name = f"cache/multi_value_error_go_last_second_layer.npy.npz"
    np_file = np.load(cache_name, allow_pickle=True)
