...
def main():
    ...
    if args.do_visual:
        ...
        for file in [0]:
            ...
            if calculate_metric:
                args.test_data_file = 'test.csv'  # df_nv_all_random_pair.csv    df_v_all_paired.csv  df_v_all_paired_index_correct.csv  df_nv_all_random_pair_index_correct.csv
            paired_flag=True
            calculate_metric = True
            if paired_flag:
                args.test_data_file = 'test.csv'  # df_nv_all_random_pair.csv  df_v_all_paired.csv
