...
--output_dir=./saved_models_binary_category_without_LineVul_add_after_to_before_percent_30 \
--model_type=roberta \
--tokenizer_name=microsoft/codebert-base \
--model_name_or_path=microsoft/codebert-base \
--do_train \
--do_test \
--train_data_file=../../data/MSR/train_add_after_percent/train_add_after_percent_30.csv  \
--eval_data_file=../../data/MSR/train_add_after_percent/val_add_after_percent_30.csv  \
--test_data_file=../../data/MSR/train_add_after_percent/test_add_after_percent_30.csv  \
--epochs 100 \
--block_size 512 \
--train_batch_size 16 \
--eval_batch_size 16 \
