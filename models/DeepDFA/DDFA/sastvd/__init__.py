...
def storage_dir() -> Path:
    ...
    #     return Path(storage) / "storage"
    # return Path(__file__).parent.parent / "storage"
    # return Path('/data2/cs_lzhan011/vulnerability/DeepDFA_V2/DDFA/storage')
    # return Path('/data2/cs_lzhan011/vulnerability/DeepDFA_V2/DDFA/storage_diversevul')

    # return Path('/data2/cs_lzhan011/vulnerability/DeepDFA_V2/DDFA/storage_add_after_to_before')
    return Path('/data2/cs_lzhan011/vulnerability/DeepDFA_V2/DDFA/storage_add_after_to_before_work_well_20240528')  #3GPU
    # return Path('/data2/cs_lzhan011/vulnerability/DeepDFA_V2/DDFA/storage_add_after_to_before_work_well_20240528_v2')  #3GPU  Setting 3   only_before

    # return Path('/data2/cs_lzhan011/vulnerability/DeepDFA_V2/DDFA/storage_MSR')  # 2GPU
    # return Path('/data2/cs_lzhan011/vulnerability/DeepDFA_V2/DDFA/storage_Diversevul_add_after_to_before')  # 2GPU
    # return Path('/data2/cs_lzhan011/vulnerability/DeepDFA_V2/DDFA/storage_Diversevul_only_before')  # 2GPU
    # return Path('/data2/cs_lzhan011/vulnerability/DeepDFA_V2/DDFA/storage_Rabib_Preprocess')
