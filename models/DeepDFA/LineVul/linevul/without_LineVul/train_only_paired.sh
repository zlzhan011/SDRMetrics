...
python linevul_main_without_LineVul_train.py --model_name=linevul_only_paired.bin \
--output_dir=./saved_models_binary_category_without_LineVul_only_paired \
--model_type=roberta \
--tokenizer_name=microsoft/codebert-base \
--model_name_or_path=microsoft/codebert-base \
--do_test \
--train_data_file=../../data/MSR/train_only_paired.csv \
--eval_data_file=../../data/MSR/val_only_paired.csv \
--test_data_file=../../data/MSR/test_only_paired.csv \
--epochs 100 \
--block_size 512 \
--train_batch_size 16 \
--eval_batch_size 16 \
