...
class TextDataset(Dataset):
    def __init__(self, tokenizer, args, file_type="train"):
        ...
        func_key = 'func_before'  # func_after  func_before processed_func  processed_func
...
def train(args, train_dataset, model, tokenizer, eval_dataset):
    ...
    for idx in range(args.epochs):
        ...
        idx_10 = idx + 10
        loss_df_df.to_csv(os.path.join(args.output_dir, 'batch_loss', args.MSR_processing_flag + 'batch_loss_'+str(idx_10)+'.csv'))
...
def evaluate(args, model, tokenizer, eval_dataset, eval_when_training=False):
    ...
    if len(list(set(y_trues.tolist())))==2:
        ...
        y_preds_trues.to_excel(
            os.path.join(args.input_file_dir, 'LineVul', args.MSR_processing_flag, "val_" + args.input_column+"_prediction.xlsx"))
