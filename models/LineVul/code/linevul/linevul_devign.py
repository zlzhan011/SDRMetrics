...
def main():
    ...
    ## parameters
    parser.add_argument("--train_data_file", default="devign_train.csv", type=str, required=False,
                        help="The input training data file (a csv file).")
    parser.add_argument("--output_dir", default="./saved_models_20230908_succ_bak", type=str, required=False,
    ...
    parser.add_argument("--eval_data_file", default="devign_valid.csv", type=str,
                        help="An optional input evaluation data file to evaluate the perplexity on (a text file).")
    parser.add_argument("--test_data_file", default="devign_test.csv", type=str,
                        help="An optional input evaluation data file to evaluate the perplexity on (a text file).")
