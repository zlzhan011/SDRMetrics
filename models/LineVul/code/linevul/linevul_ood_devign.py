...
def main():
    ...
    if args.do_ood:
        ...
        result = ood(args, model, tokenizer, test_dataset, eval_when_training=True, file_type='devign_test')

        train_dataset = TextDataset(tokenizer, args, file_type='train')
        result = ood(args, model, tokenizer, train_dataset, eval_when_training=True, file_type='devign_train')
