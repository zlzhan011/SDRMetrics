...
def t_test(args, model, tokenizer, test_dataset, flowgnn_dataset, output_dir, best_threshold=0.5):
    ...
    if len(list(set(y_trues.tolist()))) == 2:
        ...
        import json
        model_name = 'DeepDFA'
        test_type = 'Mix_Project_Resample'
        # if args.paired_flag:
        test_type = 'Mix_Project_Resample_Paired_func_before'
        ...
        softmax_entry_output = os.path.join(softmax_entry_output, model_name, args.fold_dir)
