...
class TextDataset(Dataset):
    def __init__(self, tokenizer, args, file_type="train"):
        ...
        labels = df[target_key].astype(int).tolist()
...
def main():
    ...
    parser.add_argument("--input_dir", default="/data/cs_lzhan011/data/cs_lzhan011/vulnerability/data-package/models/Devign_ReVeal/code/data/MSR/split_dataset/", type=str, required=False,
                        help="The output directory where the model predictions and checkpoints will be written.")

    parser.add_argument("--output_dir", default="./saved_models_reveal_split_dataset", type=str, required=False,
                        help="The output directory where the model predictions and checkpoints will be written.")
    ...
    parser.add_argument("--test_data_file", default="valid.csv", type=str,
                        help="An optional input evaluation data file to evaluate the perplexity on (a text file).")
