#%%
from DDFA.sastvd.linevd.graphmogrifier import get_nodes_df
sample_mode = True
...
#%%
import DDFA.sastvd.helpers.codebert as svdc
d2v = None
glove_dict = None
...
#%%
from DDFA.sastvd.linevd.graphmogrifier import get_graphs
