...
def main():
    ...
    ## parameters
    parser.add_argument("--ood_data_file", default="java.csv", type=str, required=False,
                        help="The input training data file (a csv file).")
    parser.add_argument("--train_data_file", default="ruby.csv", type=str, required=False,
                        help="The input training data file (a csv file).")
    parser.add_argument("--output_dir", default="./saved_models_value_error", type=str, required=False,
    ...
    parser.add_argument("--eval_data_file", default="six_pl.csv", type=str,
                        help="An optional input evaluation data file to evaluate the perplexity on (a text file).")
    parser.add_argument("--test_data_file", default="php.csv", type=str,
                        help="An optional input evaluation data file to evaluate the perplexity on (a text file).")
    ...
    if args.do_ood:
        ...
        # result = ood(args, model, tokenizer, test_dataset, eval_when_training=True, file_type='value_error_php')

        train_dataset = TextDataset(tokenizer, args, file_type='train')
        result = ood(args, model, tokenizer, train_dataset, eval_when_training=True, file_type='value_error_ruby')

        train_dataset = TextDataset(tokenizer, args, file_type='eval')
        result = ood(args, model, tokenizer, train_dataset, eval_when_training=True, file_type='value_error_six_pl')


        train_dataset = TextDataset(tokenizer, args, file_type='ood')
        result = ood(args, model, tokenizer, train_dataset, eval_when_training=True, file_type='value_error_java')
