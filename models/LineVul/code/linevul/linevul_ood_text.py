...
def main():
    ...
    parser.add_argument("--ood_data_file", default="text_aclImdb_train_pos.csv", type=str, required=False,
                        help="The input training data file (a csv file).")
    parser.add_argument("--output_dir", default="./saved_models_bak_two_target_no_merge", type=str, required=False,
    ...
    if args.do_ood:
        ...
        result = ood(args, model, tokenizer, test_dataset, eval_when_training=True, file_type='text_test')

        # train_dataset = TextDataset(tokenizer, args, file_type='train')
        # result = ood(args, model, tokenizer, train_dataset, eval_when_training=True, file_type='text_train')

        # train_dataset = TextDataset(tokenizer, args, file_type='ood')
        # result = ood(args, model, tokenizer, train_dataset, eval_when_training=True, file_type='devign_ood')
