...
def main():
    ...
    ## parameters
    parser.add_argument("--ood_data_file", default="_CME_value_error_ttv_ood_type_4.csv", type=str, required=False,
                        help="The input training data file (a csv file).")
    parser.add_argument("--train_data_file", default="train_CME_value_error_multi_type.csv", type=str, required=False,
                        help="The input training data file (a csv file).")
    ...
    parser.add_argument("--eval_data_file", default="valid_CME_value_error_multi_type.csv", type=str,
                        help="An optional input evaluation data file to evaluate the perplexity on (a text file).")
    parser.add_argument("--test_data_file", default="test_CME_value_error_multi_type.csv", type=str,
                        help="An optional input evaluation data file to evaluate the perplexity on (a text file).")
    ...
    if args.do_ood:
        ...
        result = ood(args, model, tokenizer, test_dataset, eval_when_training=True, file_type='value_error_test')

        train_dataset = TextDataset(tokenizer, args, file_type='train')
        result = ood(args, model, tokenizer, train_dataset, eval_when_training=True, file_type='value_error_train')

        train_dataset = TextDataset(tokenizer, args, file_type='ood')
        result = ood(args, model, tokenizer, train_dataset, eval_when_training=True, file_type='value_error_ood')
