...
def main():
    ...
    ## parameters
    parser.add_argument("--ood_data_file", default="synthetic_testv3.csv", type=str, required=False,
    ...
    parser.add_argument("--eval_data_file", default="synthetic_testv3.csv", type=str,
                        help="An optional input evaluation data file to evaluate the perplexity on (a text file).")
    parser.add_argument("--test_data_file", default="synthetic_testv3.csv", type=str,
                        help="An optional input evaluation data file to evaluate the perplexity on (a text file).")
