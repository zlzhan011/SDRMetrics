...
def main():
    ...
    parser.add_argument("--output_dir",
                        default="/data/cs_lzhan011/data/cs_lzhan011/vulnerability/data-package/models/LineVul/code/linevul/binary_category/check_result_of_after_before",
    ...
    if args.do_visual:
        ...
        for file in [0]:
            ...
            if calculate_metric:
                args.test_data_file = 'df_nv_all_random_pair_index_correct.csv'  # df_nv_all_random_pair.csv    df_v_all_paired.csv  df_v_all_paired_index_correct.csv  df_nv_all_random_pair_index_correct.csv
            paired_flag=True
            calculate_metric = True
            if paired_flag:
                args.test_data_file = 'df_nv_all_random_pair_index_correct.csv'  # df_nv_all_random_pair.csv  df_v_all_paired.csv
