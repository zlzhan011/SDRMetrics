...
python linevul_main_multi_category_train.py \
  ...
  --output_dir=./saved_models_multi_category_nodownsample_no_kfold \
  --model_type=roberta \
  ...
  --seed $seed $@ 2>&1 | tee "test_multi_category__nodownsample_no_kfold.log"





#--model_name=1_linevul.bin
#--output_dir=./saved_models_multi_category
#--model_type=roberta
#--tokenizer_name=microsoft/codebert-base
#--model_name_or_path=microsoft/codebert-base
#--do_test
...
#  --eval_data_file=${input_dir}/${kfold_section}/train.csv \
#  --test_data_file=${input_dir}/${kfold_section}/train.csv \
#  --epochs 10 \
#  --block_size 512 \
#  --train_batch_size 16 \
#  --eval_batch_size 16 \
