...
class BigVulDatasetLineVDDataModule(pl.LightningDataModule):
    ...
    def positive_weight(self):
        if self.use_weighted_loss:
            ...
            print("Positive weight: %f positives: %d negatives: %d", pos_weight, num_positives, num_negatives)
            return pos_weight
        else:
            return None
    ...
    def train_dataloader(self):
        ...
        if self.use_random_weighted_sampler:
            ...
            print("self.use_random_weighted_sampler true")
            ...
            print("self.use_random_weighted_sampler false")
            print("self.batch_size:", self.batch_size)
